...
The full explanation of each pattern — why it works, when it applies, what the
trap is. This is the **learn it the first time** layer.

Already know the topic and just need to reload? Go to
[`cheatsheets/`](../cheatsheets/) instead.
