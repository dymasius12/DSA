...
Stubs with a docstring spec and a complexity target. **Fill in the body** — the
...
Stuck more than 25 minutes? Read [`solutions/`](../solutions/), close it, and
rewrite it from memory tomorrow. That's the method, not cheating.
